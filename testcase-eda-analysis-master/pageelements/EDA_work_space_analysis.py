...
class EDAPage(BasePage):
    ...
    def add_workspace_dt10min_data1(self):
        ...
        # 如果“jing.huang_分析设计”不存在
            ...
            self.find_element("xpath",
                              ...
                              "v[4]/div[1]/div[2]/div/div/div[1]/div[1]/div[1]/div/div[2]/div/button").click()
    ...
    def add_workspace_dt10min_data2(self):
        ...
        # 点击预览按钮
        self.find_element_by_xpath(
            '//*[@id="root"]/div/section/section/section/main/div[1]/div[4]/div[2]/di'
            'v[2]/div/div[3]/div[1]/div/div[1]/div/div[2]/div/button[1]').click()
    ...
    # 画出dt10min柱状图
    def add_workspace_dt10min_data4(self):
        # 点击柱状图按钮
        self.find_element_by_xpath(
            '//*[@id="root"]/div/section/section/section/main/div[1]/div[4]/div[2]/div[2]/div/div[2]/div[2]/d'
            'iv/div[2]/div[1]/div/label[3]').click()
    ...
    # 展示dt10min图表
    def add_workspace_dt10min_data_X(self):
        # 点击数据表按钮
        self.find_element_by_xpath(
            '//*[@id="root"]/div/section/section/section/main/div[1]/div[4]/div[2]/div[2]/div/div[2]/div[2]/d'
